...
export class SaveWorktimeEntryService {
    ...
    saveWorktimeEntry(worktimeEntryRequestData){
        ...
        writeEntryToDay(this.database, worktimeEntryRequestData.id, worktimeEntryRequestData.date, worktimeEntryRequestData.description, worktimeEntryRequestData.time)
    }
